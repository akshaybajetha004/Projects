"""
Django settings for Sportsbuzz project.
...
WSGI_APPLICATION = 'Sportsbuzz.wsgi.application'
...
if 'test' in sys.argv:
    ...
    DATABASES = {
            'default': {
                ...
                'NAME': 'd2rf3avnu0ianj',
                'USER': 'kaqbcovhbwgqin',
                'PASSWORD': '7216b52c62cb67d8ddd9d8c1ff33969a5d6f2151a81ff2860c6cd3f96b5e46d0',
...
CRONJOBS = [
    ('20 */2 * * *', 'articles.cron.main_scrapping')
]
